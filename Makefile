.PHONY: help install clean data features soil reports all
...
help:
	...
	@echo "  make features   - Generar features climáticos y dataset maestro"
	@echo "  make soil       - Integrar suelo y entrenar modelo clima+suelo (XAI)"
	@echo "  make reports    - Generar informes HTML + Markdown"
	@echo "  make all        - Pipeline completo: data + features + soil + reports"
